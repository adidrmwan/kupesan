...
<section class="page-cover" id="cover-hotel-detail">
    <div class="container">
        <div class="row">
            <div class="col-sm-12">
            	<h1 class="page-title">Studio A</h1>
            	<h5> Jalan A </h5>
            </div><!-- end columns -->
        </div><!-- end row -->
    </div><!-- end container -->
            ...
            <div class="row">        	
                ...
                <div class="col-xs-12 col-sm-12 col-md-3 side-bar right-side-bar">
                    ...
                    <div class="side-bar-block booking-form-block">
                    	<h2 class="selected-price">Rp. 150.000 <span>Per jam</span></h2>
                    
                    	<div class="booking-form">
                        	<h3>Book Studio</h3>
                            <p>Find your studio today</p>
                            ...
                            <form>
                                ...
                                <div class="form-group">
                            		<input type="text" class="form-control dpd1" placeholder="Jam Mulai" required/>
                            		<i class="fa fa-calendar"></i>
                                </div>
                                
                                <div class="form-group">
                            		<input type="text" class="form-control dpd2" placeholder="Jam Selesai" required/>
                               		<i class="fa fa-calendar"></i>
                                </div>
