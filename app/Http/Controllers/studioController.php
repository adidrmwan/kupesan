...
class StudioController extends Controller
{
    public function detailFotostudio(Request $request)
    {
        ...
        return view('detail-partner.fotostudio', ['detail' => $detail, 'thematic' => $thematic, 'special' => $special, 'alacarte' => $alacarte, 'album' => $album, 'fasilitas' => $fasilitas, 'booking_date' => $booking_date]);
    }
